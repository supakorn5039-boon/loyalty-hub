...
import { X, RefreshCw, ShieldCheck, Clock } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs">
        <motion.div
          ...
          className="relative w-full max-w-sm bg-white rounded-3xl p-6 border border-slate-200 shadow-xl text-center text-slate-900"
        >
          {/* Close button */}
          <button
            onClick={onClose}
